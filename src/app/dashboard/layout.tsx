      ...
      >
          ...
          {navigation.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                onClick={() => setMobileMenuOpen(false)}
                className={`group flex items-center pl-6 pr-3 py-3 text-base font-medium rounded-lg transition-colors ${
                  item.current
        ...
        <div className="p-4 border-t border-gray-700 space-y-2">
          <Link
            href="/"
            onClick={() => setMobileMenuOpen(false)}
            className="group flex items-center pl-6 pr-3 py-2 text-base font-medium text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white transition-colors"
          >
